...
Route::middleware('guest')->group(function () {
    ...
    Route::get('register/hospital', [RegisteredHospitalController::class, 'create'])
        ->name('register.hospital');
    Route::post('register/hospital', [RegisteredHospitalController::class, 'store']);
    ...
    Route::get('register/pharmacist', [RegisteredPharmacistController::class, 'create'])
        ->name('register.pharmacist');
    Route::post('register/pharmacist', [RegisteredPharmacistController::class, 'store']);
